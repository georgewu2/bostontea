...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"orangetrain.jpg"]];
}
...
{
    // show the picker when user selects station
...
{    
    ...
    NSMutableArray *trains = [Search searchMBTA:@"orange"
