...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"train.jpg"]];
...
- (IBAction)submitClicked:(id)sender
{
    ...
    NSMutableArray *trains = [Search searchMBTA:@"red"
    ...
    if (error)
    {
        dataView.text = [[error userInfo] objectForKey:NSLocalizedDescriptionKey];
    }
    else
    {
